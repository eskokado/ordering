...
class CustomerQueryServiceIT {
  ...
  public void shouldFilterByPage() {
    customers.add(
        CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).fullName(new FullName("Ana", "Silva")).build());
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
        .fullName(new FullName("Bruno", "Costa")).build());
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
        .fullName(new FullName("Carla", "Souza")).build());
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
        .fullName(new FullName("Daniel", "Pereira")).build());
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
        .fullName(new FullName("Eduarda", "Santos")).build());
  ...
  public void shouldFilterByFirstName() {
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
        .fullName(new FullName("Alice", "Smith")).build());
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
        .fullName(new FullName("Bob", "Johnson")).build());
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
        .fullName(new FullName("Alice", "Williams")).build());
  ...
  public void shouldFilterByEmail() {
    customers.add(
        CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).email(new Email("user1@test.com")).build());
    customers.add(
        CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).email(new Email("test2@algashop.com")).build());
    customers.add(
        CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).email(new Email("user3@test.com")).build());
  ...
  public void shouldIgnoreBlankEmailWhenFiltering() {
    customers.add(
        CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).email(new Email("user1@test.com")).build());
    customers.add(
        CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).email(new Email("user2@test.com")).build());
  ...
  public void shouldFilterByMultipleParams() {
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).fullName(new FullName("John", "Doe"))
        .email(new Email("johndoe@email.com")).build());
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).fullName(new FullName("Jane", "Doe"))
        .email(new Email("janedoe@email.com")).build());
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
        .fullName(new FullName("John", "Smith")).email(new Email("johnsmith@email.com")).build());
  ...
  public void shouldOrderByFirstNameAsc() {
    customers.add(
        CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).fullName(new FullName("Zoe", "Doe")).build());
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
        .fullName(new FullName("Charlie", "Smith")).build());
    customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
        .fullName(new FullName("Alice", "Williams")).build());
  ...
  public void givenNonMatchingFilter_shouldReturnEmptyPage() {
    customers.add(
        CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).fullName(new FullName("John", "Doe")).build());
