...
class OrderPersistenceEntityAssemblerTest {
  ...
  void givenNullAddress_whenInvokeToAddressEmbeddable_shouldReturnNull() throws Exception {
    var method = OrderPersistenceEntityAssembler.class
        .getDeclaredMethod("toAddressEmbeddable", com.eskcti.algashop.ordering.core.domain.model.commons.Address.class);
  ...
  void givenNullRecipient_whenInvokeToRecipientEmbeddable_shouldReturnNull() throws Exception {
    var method = OrderPersistenceEntityAssembler.class
        .getDeclaredMethod("toRecipientEmbeddable",
            com.eskcti.algashop.ordering.core.domain.model.order.Recipient.class);
    method.setAccessible(true);
  ...
  void givenOrderMockWithNullItems_whenMerge_shouldRemovePersistenceEntityItems() {
    ...
    Mockito.when(order.customerId())
        .thenReturn(new com.eskcti.algashop.ordering.core.domain.model.customer.CustomerId(customerId));
    Mockito.when(order.totalAmount()).thenReturn(new com.eskcti.algashop.ordering.core.domain.model.commons.Money("0"));
    Mockito.when(order.totalItems()).thenReturn(com.eskcti.algashop.ordering.core.domain.model.commons.Quantity.ZERO);
    Mockito.when(order.status()).thenReturn(com.eskcti.algashop.ordering.core.domain.model.order.OrderStatus.DRAFT);
