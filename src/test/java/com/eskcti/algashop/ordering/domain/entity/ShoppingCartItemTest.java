...
import com.eskcti.algashop.ordering.domain.exception.ShoppingCartItemIncompatibleProductException;
...
class ShoppingCartItemTest {
    ...
    void given_shoppingCartItemsWithDifferentId_whenCompare_shouldNotBeEqual() {
        ShoppingCartId cartId = new ShoppingCartId();
        ShoppingCartItem first = ShoppingCartItemTestDataBuilder.existingItem(cartId).id(new ShoppingCartItemId())
                .build();
        ShoppingCartItem second = ShoppingCartItemTestDataBuilder.existingItem(cartId).id(new ShoppingCartItemId())
                .build();
    ...
    void given_nullRequiredFields_whenBuildExistingShoppingCartItem_shouldGenerateException() {
        ...
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.existingItem(cartId).id(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.existingItem(cartId).shoppingCartId(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.existingItem(cartId).productId(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.existingItem(cartId).productName(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.existingItem(cartId).price(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.existingItem(cartId).quantity(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.existingItem(cartId).available(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.existingItem(cartId).totalAmount(null).build());
    }
    ...
    void given_nullRequiredFields_whenBuildBrandNewShoppingCartItem_shouldGenerateException() {
        ...
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.brandNewItem(cartId).shoppingCartId(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.brandNewItem(cartId).productId(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.brandNewItem(cartId).productName(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.brandNewItem(cartId).price(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.brandNewItem(cartId).available(null).build());
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> ShoppingCartItemTestDataBuilder.brandNewItem(cartId).quantity(null).build());
    }
